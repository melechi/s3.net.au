<li class="productItem">
	<div class="image"><% if Image %>
		<a href="$Link" title="Click here to read more on &quot;{$Title}&quot;"><img src="$Image.Thumbnail.URL" alt="$Title image" /></a>
	<% else %>
		<a href="$Link" title="Click here to read more on &quot;{$Title}&quot;"><img src="themes/itheme_ecommerce/images/productPlaceHolderThumbnail.gif" alt="Sorry, no product image for &quot;{$Title}&quot;" /></a>
	<% end_if %>
	</div>
